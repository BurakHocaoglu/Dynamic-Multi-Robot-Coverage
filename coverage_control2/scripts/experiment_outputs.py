...
if __name__ == "__main__":
	...
	workload_history = dict()
	average_areas = dict()
	max_geodesic_dists = dict()

	agent_count_dirs = os.listdir(exp_data_path)
	for count in agent_count_dirs:
		data_path = "{}/{}".format(exp_data_path, count)
		...
		for data_file in data_files:
			...
			try:
				with open("{}/{}".format(data_path, data_file), "r+") as E:
					exp_hist = json.load(E)
